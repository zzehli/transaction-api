...
public class TransactionRepositoryImpl implements TransactionRepository{
    ...
    private static final String SQL_CREATE = "INSERT INTO TRANSACTIONS (TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE) VALUES(NEXTVAL('TRANSACTIONS_SEQ'), ?, ?, ?, ?, ?)";
    ...
    public Integer create(Integer userId, Integer categoryId, Double amount, String note, Long transactionDate) throws EtBadRequestException {
        try {
            ...
            throw new EtBadRequestException("Invalid create transaction request");
        }
    }
    ...
    public void removeById(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
        int count = jdbcTemplate.update(SQL_DELETE);
        if (count == 0)
            throw new EtResourceNotFoundException("Transaction not found");
    }
