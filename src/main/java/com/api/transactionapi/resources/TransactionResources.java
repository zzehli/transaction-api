...
import com.api.transactionapi.services.TransactionService;
...
//        System.out.println("userId " + userId + " categoryId " + categoryId + " amount " + amount + " note " + note + " transactionDate " + transactionDate );
